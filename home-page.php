...
<div class = 'container'>
<h2><?php the_field( 'titleforaboutme' );
?></h2><!--  custom field for the aboutme content-->
<p class = 'particle'><?php the_field( 'subtitleforaboutme' );
?></p>
<p class = 'about-text'><?php the_field( 'paragraphforaboutme' );
?></p>
...
<h3 class = 'text-center article-title '><?php the_field( 'titleforarticles' );
?></h3>
</div>
<div class = 'col-md-4 article-cent'>
<img class = 'img-responsive' alt = “portait” src = "<?php the_field('articleimage'); ?>">
<h4><?php the_field( 'articletitle' );
?></h4>
<p><?php the_field( 'articleexcerpt' );
?> </p>
<a href = "<?php the_field('readmore'); ?>" class = 'readmore'>CONTINUE READING</a>
</div>
<div class = 'col-md-4 article-cent'>
<img class = 'img-responsive' alt = “portait” src = "<?php the_field('articleimage2'); ?>">
<h4><?php the_field( 'articletitle2' );
?></h4>
<p><?php the_field( 'articleexcerpt2' );
?> </p>
...
<h4><?php the_field( 'articletitle3' );
?></h4>
<p><?php the_field( 'articleexcerpt3' );
?> </p>
